...
func (a *ofFlowAction) Learn(id uint8, priority Priority, idleTimeout, hardTimeout uint16, cookieID uint64) LearnAction {
	la := &ofLearnAction{
		flowBuilder: a.builder,
		nxLearn:     ofctrl.NewLearnAction(id, priority.Value(), idleTimeout, hardTimeout, 0, 0, cookieID),
	}
	return la
}
