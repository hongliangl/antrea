...
type OVSBridgeClient interface {
	...
	CreateTunnelPortExt(name string, tunnelType TunnelType, ofPortRequest int32, csum bool, localIP string, remoteIP string, remoteName string, psk string, extraOptions map[string]interface{}, externalIDs map[string]string) (string, error)
