...
func (m *MockOVSBridgeClient) CreateTunnelPortExt(name string, tunnelType ovsconfig.TunnelType, ofPortRequest int32, csum bool, localIP, remoteIP, remoteName, psk string, extraOptions map[string]any, externalIDs map[string]string) (string, error) {
	m.ctrl.T.Helper()
