...
type AgentConfig struct {
	...
	// HostNetworkAccelerationConfig configures acceleration of traffic in Node host network.
	HostNetworkAccelerationConfig HostNetworkAccelerationConfig `yaml:"hostNetworkAccelerationConfig,omitempty"`
}
