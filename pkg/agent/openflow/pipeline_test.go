	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedFlows: []string{
				...
				"cookie=0x1000000000000, table=PreRoutingClassifier, priority=0 actions=goto_table:NodePortMark",
				"cookie=0x1000000000000, table=NodePortMark, priority=0 actions=goto_table:SessionAffinity",
