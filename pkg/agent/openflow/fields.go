...
var (
	...
	//   - 1: to Antrea gateway interface.
	//   - 2: to local Pods.
	//   - 3: to uplink interface.
	//   - 4: to bridge local interface.
	...
	ToBridgeRegMark     = binding.NewRegMark(PktDestinationField, 4)
	...
	// reg0[13..14]: Field to indicate disposition of Antrea Policy. It could have more bits to support more dispositions
...
var (
	...
	// This CT mark is used both in CtZone / CtZoneV6 and SNATCtZone / SNATCtZoneV6.
