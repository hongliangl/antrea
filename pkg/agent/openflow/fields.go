...
var (
	// reg0 (NXM_NX_REG0)
	// reg0[0..3]: Field tomark the packet source. Marks in this field include,
...
// Marks using CT.
var (
	//TODO: There is a bug in lib!Openflow when CT_MARK range is from 0 to 0, and a wrong mask will be got,
	// so bit 0 of CT_MARK should not be used for now.
