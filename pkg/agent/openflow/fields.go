...
var (
	...
	// reg4[21]: Mark to indicate whether the Service has external IP, like NodePort, LoadBalancer or ExternalIP.
	ExternalAddressRegMark = binding.NewOneBitRegMark(4, 21)
