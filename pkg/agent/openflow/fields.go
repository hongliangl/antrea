...
var (
	...
	// PacketUnionField is used to mark hairpin case.
	PacketUnionField              = binding.NewRegField(0, 0, 7, "PacketUnion")
	GatewayNodeHairpinRegMark     = binding.NewRegMark(PacketUnionField, (5<<4)|1)
	GatewayExternalHairpinRegMark = binding.NewRegMark(PacketUnionField, (6<<4)|1)
	...
	// reg4[22..23]: Field to mark the Egress traffic
	EgressRegMark    = binding.NewOneBitRegMark(4, 24, "Egress")
	NotEgressRegMark = binding.NewOneBitZeroRegMark(4, 24, "Egress")
