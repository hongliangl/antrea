...
var (
	...
	// for L7 Antrea NetworkPolicy.
	// This CT mark is used in CtZone / CtZoneV6.
	L7ANPRedirectCTMark = binding.NewOneBitCTMark(7)
)
...
var (
	...
	// Field to store the VLAN ID allocated for a L7 Antrea NetworkPolicy rule.
	L7ANPRuleVlanIDCTLabel = binding.NewCTLabel(64, 75)
)
