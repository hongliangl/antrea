	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedFlows: []string{
				...
				"cookie=0x1040000000000, table=L3Forwarding, priority=190,ct_state=-rpl+trk,ip,reg0=0x1/0xf actions=set_field:00:00:10:10:00:01->eth_dst,goto_table:EgressMark",
		...
		},
		{
			...
			expectedFlows: []string{
				...
				"cookie=0x1040000000000, table=L3Forwarding, priority=190,ct_state=-rpl+trk,ipv6,reg0=0x1/0xf actions=set_field:00:00:10:10:00:01->eth_dst,goto_table:EgressMark",
