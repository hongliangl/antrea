	...
	testCases := []struct {
		...
		},
		{
			...
			expectedFlows: []string{
				...
				"cookie=0x1010000000000, table=L3Forwarding, priority=200,ipv6,ipv6_dst=fec0:10:10:1::/80 actions=set_field:00:00:10:10:00:01->eth_src,set_field:aa:bb:cc:dd:ee:ff->eth_dst,set_field:fec0:192:168:77::101->tun_ipv6_dst,set_field:0x10/0xf0->reg0,goto_table:L3DecTTL",
			},
		},
		{
		...
		},
		{
			...
			trafficEncapMode: config.TrafficEncapModeNoEncap,
			expectedFlows: []string{
				"cookie=0x1010000000000, table=L3Forwarding, priority=200,ipv6,reg4=0x0/0x100000,ipv6_dst=fec0:10:10:1::/80 actions=set_field:00:00:10:10:00:01->eth_dst,set_field:0x20/0xf0->reg0,goto_table:L3DecTTL",
	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedFlows: []string{
				...
				"cookie=0x1010000000000, table=L3Forwarding, priority=200,ip,reg0=0x200/0x200,nw_dst=10.10.0.66 actions=set_field:00:00:10:10:00:01->eth_src,set_field:00:00:10:10:00:66->eth_dst,goto_table:L3DecTTL",
		...
		},
		{
			...
			expectedFlows: []string{
				...
				"cookie=0x1010000000000, table=L3Forwarding, priority=200,ipv6,reg0=0x200/0x200,ipv6_dst=fec0:10:10::66 actions=set_field:00:00:10:10:00:01->eth_src,set_field:00:00:10:10:00:66->eth_dst,goto_table:L3DecTTL",
				"cookie=0x1010000000000, table=L2ForwardingCalc, priority=200,dl_dst=00:00:10:10:00:66 actions=set_field:0x64->reg1,set_field:0x100/0x100->reg0,goto_table:IngressSecurityClassifier",
			},
		},
		{
...
func Test_client_InstallPodSNATFlows(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			name: "SNAT on Remote",
			expectedFlows: []string{
				"cookie=0x1040000000000, table=EgressMark, priority=200,ip,in_port=100 actions=set_field:00:00:10:10:00:01->eth_src,set_field:aa:bb:cc:dd:ee:ff->eth_dst,set_field:192.168.77.101->tun_dst,set_field:0x10/0xf0->reg0,goto_table:L2ForwardingCalc",
			},
		},
	}
...
func Test_client_InstallMulticlusterNodeFlows(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedFlows: []string{
				"cookie=0x1060000000000, table=L3Forwarding, priority=200,ip,nw_dst=10.97.0.0/16 actions=set_field:00:00:10:10:00:01->eth_src,set_field:aa:bb:cc:dd:ee:f0->eth_dst,set_field:192.168.78.101->tun_dst,set_field:0x10/0xf0->reg0,goto_table:L3DecTTL",
				"cookie=0x1060000000000, table=L3Forwarding, priority=200,ct_state=+rpl+trk,ip,nw_dst=192.168.78.101 actions=set_field:00:00:10:10:00:01->eth_src,set_field:aa:bb:cc:dd:ee:f0->eth_dst,set_field:192.168.78.101->tun_dst,set_field:0x10/0xf0->reg0,goto_table:L3DecTTL",
			},
		},
		//TODO: IPv6
	}
