...
//go:embed tcp_observability_bpfel.o
var tcpObservabilityObject []byte

type tcpObservabilityObjects struct {
	ObserveConnect4 *ebpf.Program `ebpf:"observe_connect4"`
	ObserveSockops  *ebpf.Program `ebpf:"observe_sockops"`
	Events          *ebpf.Map     `ebpf:"events"`
}

func loadTCPObservabilityObjects(objects *tcpObservabilityObjects) error {
	spec, err := ebpf.LoadCollectionSpecFromReader(bytes.NewReader(tcpObservabilityObject))
	if err != nil {
...
func (o *tcpObservabilityObjects) Close() error {
