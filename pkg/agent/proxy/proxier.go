...
func newProxier(
	...
	serviceLabelSelector := labels.NewSelector().Add(*serviceProxyNameSelector)
	...
	p := &proxier{
		...
		endpointsChanges:          newEndpointsChangesTracker(hostname, endpointSliceEnabled, isIPv6, endpointsLabelSelector),
