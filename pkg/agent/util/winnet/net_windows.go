...
// Empty handle used by the winnet package methods
...
func SetNetAdapterMTU(adapterName string, mtu int) error {
	return pkgHandle.SetNetAdapterMTU(adapterName, mtu)
}
...
func RemoveVMSwitch(vmSwitch string) error {
	return pkgHandle.RemoveVMSwitch(vmSwitch)
}
