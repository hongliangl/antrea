...
-A ANTREA-POL-PRI-INGRESS-RULES -s 192.168.1.0/24 -p tcp --dport 22 -m comment --comment "Antrea: privileged NodeNetworkPolicy: allow ingress IPv4 SSH traffic" -j ACCEPT
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			c := &Client{iptables: mockIPTables,
				...
				nodeNetworkPolicyConfig:  tt.nodeNetworkPolicyConfig,
			}
			...
			if tt.nodeNetworkPolicyEnabled {
				...
				c.nodeNetworkPolicyIPTablesIPv4.data[config.NodeNetworkPolicyIngressRulesChain] = []string{
					`-A ANTREA-POL-INGRESS-RULES -j ACCEPT -m comment --comment "mock rule"`,
				}
				c.nodeNetworkPolicyIPTablesIPv6.data[config.NodeNetworkPolicyIngressRulesChain] = []string{
					`-A ANTREA-POL-INGRESS-RULES -j ACCEPT -m comment --comment "mock rule"`,
				}
			}
...
COMMIT
`, false, false)
				mockIPTables.EnsureChain(iptables.ProtocolIPv4, iptables.FilterTable, config.NodeNetworkPolicyIngressRulesChain).Times(1)
				mockIPTables.EnsureChain(iptables.ProtocolIPv4, iptables.FilterTable, config.NodeNetworkPolicyEgressRulesChain).Times(1)
				mockIPTables.AppendRule(iptables.ProtocolIPv4, iptables.FilterTable, iptables.InputChain, gomock.Any()).Times(1)
				mockIPTables.AppendRule(iptables.ProtocolIPv4, iptables.FilterTable, iptables.OutputChain, gomock.Any()).Times(1)
...
COMMIT
`, false, false)
				mockIPTables.DeleteRule(iptables.ProtocolIPv4, iptables.FilterTable, iptables.InputChain, gomock.Any()).Times(1)
				mockIPTables.DeleteRule(iptables.ProtocolIPv4, iptables.FilterTable, iptables.OutputChain, gomock.Any()).Times(1)
				mockIPTables.DeleteChain(iptables.ProtocolIPv4, iptables.FilterTable, antreaInputChain).Times(1)
				mockIPTables.DeleteChain(iptables.ProtocolIPv4, iptables.FilterTable, antreaOutputChain).Times(1)
				mockIPTables.DeleteChain(iptables.ProtocolIPv4, iptables.FilterTable, privilegedNodeNetworkPolicyIngressRulesChain).Times(1)
				mockIPTables.DeleteChain(iptables.ProtocolIPv4, iptables.FilterTable, privilegedNodeNetworkPolicyEgressRulesChain).Times(1)
				mockIPTables.DeleteChain(iptables.ProtocolIPv4, iptables.FilterTable, config.NodeNetworkPolicyIngressRulesChain).Times(1)
				mockIPTables.DeleteChain(iptables.ProtocolIPv4, iptables.FilterTable, config.NodeNetworkPolicyEgressRulesChain).Times(1)
			},
		},
...
COMMIT
`, false, true)
				mockIPTables.EnsureChain(iptables.ProtocolIPv6, iptables.FilterTable, config.NodeNetworkPolicyIngressRulesChain).Times(1)
				mockIPTables.EnsureChain(iptables.ProtocolIPv6, iptables.FilterTable, config.NodeNetworkPolicyEgressRulesChain).Times(1)
				mockIPTables.AppendRule(iptables.ProtocolIPv6, iptables.FilterTable, iptables.InputChain, gomock.Any()).Times(1)
				mockIPTables.AppendRule(iptables.ProtocolIPv6, iptables.FilterTable, iptables.OutputChain, gomock.Any()).Times(1)
...
COMMIT
`, false, true)
				mockIPTables.DeleteRule(iptables.ProtocolIPv6, iptables.FilterTable, iptables.InputChain, gomock.Any()).Times(1)
				mockIPTables.DeleteRule(iptables.ProtocolIPv6, iptables.FilterTable, iptables.OutputChain, gomock.Any()).Times(1)
				mockIPTables.DeleteChain(iptables.ProtocolIPv6, iptables.FilterTable, antreaInputChain).Times(1)
				mockIPTables.DeleteChain(iptables.ProtocolIPv6, iptables.FilterTable, antreaOutputChain).Times(1)
				mockIPTables.DeleteChain(iptables.ProtocolIPv6, iptables.FilterTable, privilegedNodeNetworkPolicyIngressRulesChain).Times(1)
				mockIPTables.DeleteChain(iptables.ProtocolIPv6, iptables.FilterTable, privilegedNodeNetworkPolicyEgressRulesChain).Times(1)
				mockIPTables.DeleteChain(iptables.ProtocolIPv6, iptables.FilterTable, config.NodeNetworkPolicyIngressRulesChain).Times(1)
				mockIPTables.DeleteChain(iptables.ProtocolIPv6, iptables.FilterTable, config.NodeNetworkPolicyEgressRulesChain).Times(1)
			},
		},
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			var gotRules []string
			if tt.isIPv6 {
				gotRules = c.nodeNetworkPolicyIPTablesIPv6.load(ingressChain)
			} else {
				gotRules = c.nodeNetworkPolicyIPTablesIPv4.load(ingressChain)
			}
			...
			if tt.isIPv6 {
				gotRules = c.nodeNetworkPolicyIPTablesIPv6.load(svcChain)
			} else {
				gotRules = c.nodeNetworkPolicyIPTablesIPv4.load(svcChain)
			}
			...
			assert.EqualValues(t, []string{}, gotRules)
