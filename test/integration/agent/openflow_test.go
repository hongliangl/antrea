	...
	for _, ep := range endpointList {
		...
		if ep.GetIsLocal() {
			hairpinFlows.flows = append(hairpinFlows.flows, &ofTestUtils.ExpectFlow{
				...
				ActStr:   "load:0x1->NXM_NX_REG0[9],load:0x1->NXM_NX_REG0[10],load:0->NXM_NX_REG4[22..23],goto_table:IPTTLDec",
			})
		}
	}
				...
				[]*ofTestUtils.ExpectFlow{
					{
						...
						ActStr:   fmt.Sprintf("set_field:%s->eth_src,set_field:%s->eth_dst,load:0x2->NXM_NX_REG0[4..7],goto_table:ServiceHairpinMark", gwMAC.String(), podMAC.String()),
					},
				},
			},
		)
			...
			[]*ofTestUtils.ExpectFlow{
				{
					...
					ActStr:   fmt.Sprintf("set_field:%s->eth_dst,load:0x6->NXM_NX_REG0[4..7],goto_table:ServiceHairpinMark", peerNodeMAC.String()),
				},
			},
		})
	}
...
func prepareDefaultFlows(config *testConfig) []expectTableFlows {
	...
	tableL3ForwardingFlows := expectTableFlows{
		"L3Forwarding",
		[]*ofTestUtils.ExpectFlow{{MatchStr: "priority=0", ActStr: "load:0x6->NXM_NX_REG0[4..7],goto_table:L2Forwarding"}},
	}
	...
	if config.enableIPv4 {
		...
		tableSNATConntrackCommitFlows.flows = append(tableSNATConntrackCommitFlows.flows,
			&ofTestUtils.ExpectFlow{
				MatchStr: "priority=200,ct_state=+new+trk,ip,reg0=0x200/0x200,reg4=0/0xc00000",
				ActStr:   "load:0x3->NXM_NX_REG4[22..23],ct(commit,table=SNATConntrackCommit,zone=65520,exec(load:0x1->NXM_NX_CT_MARK[4],load:0x1->NXM_NX_CT_MARK[5]))",
			},
			&ofTestUtils.ExpectFlow{
				MatchStr: "priority=200,ct_state=+new+trk,ip,reg0=0x1/0xf,reg4=0x400000/0xc00000",
				ActStr:   "load:0x3->NXM_NX_REG4[22..23],ct(commit,table=SNATConntrackCommit,zone=65520,exec(load:0x1->NXM_NX_CT_MARK[4]))",
			},
			&ofTestUtils.ExpectFlow{
				MatchStr: "priority=200,ct_state=+new+trk,ip,reg0=0x200/0x600,reg4=0xc00000/0xc00000",
			...
			&ofTestUtils.ExpectFlow{
				MatchStr: "priority=200,ct_state=+new+trk,ip,reg0=0x600/0x600,reg4=0xc00000/0xc00000",
			...
			&ofTestUtils.ExpectFlow{
				MatchStr: "priority=190,ct_state=+new+trk,ip,reg0=0x1/0xf,reg4=0xc00000/0xc00000",
				ActStr:   fmt.Sprintf("ct(commit,table=L2Forwarding,zone=65521,nat(src=%s),exec(load:0x1->NXM_NX_CT_MARK[2]))", config.nodeConfig.GatewayConfig.IPv4),
			},
			&ofTestUtils.ExpectFlow{
		...
		tableL3ForwardingFlows.flows = append(tableL3ForwardingFlows.flows,
			&ofTestUtils.ExpectFlow{MatchStr: fmt.Sprintf("priority=200,ip,reg0=0/0x800,nw_dst=%s", nodeIPStr), ActStr: "load:0x5->NXM_NX_REG0[4..7],goto_table:L2Forwarding"},
			&ofTestUtils.ExpectFlow{MatchStr: fmt.Sprintf("priority=200,ip,reg0=0x800/0x800,nw_dst=%s", nodeIPStr), ActStr: fmt.Sprintf("load:0x5->NXM_NX_REG0[4..7],set_field:%s->eth_dst,goto_table:ServiceHairpinMark", config.nodeConfig.GatewayConfig.MAC)},
		...
		tableServiceHairpinMarkFlows.flows = append(tableServiceHairpinMarkFlows.flows,
			...
			&ofTestUtils.ExpectFlow{MatchStr: "priority=190,ct_state=+new+trk,ip,reg0=0x51/0xff", ActStr: "load:0x1->NXM_NX_REG0[9],load:0->NXM_NX_REG4[22..23],load:0->NXM_NX_REG0[10],goto_table:IPTTLDec"},
			&ofTestUtils.ExpectFlow{MatchStr: "priority=190,ct_state=+new+trk,ip,reg0=0x61/0xff", ActStr: "load:0x1->NXM_NX_REG0[9],load:0->NXM_NX_REG4[22..23],load:0->NXM_NX_REG0[10],goto_table:IPTTLDec"},
		)
	...
	if config.enableIPv6 {
		...
		tableSNATConntrackCommitFlows.flows = append(tableSNATConntrackCommitFlows.flows,
			&ofTestUtils.ExpectFlow{
				MatchStr: "priority=200,ct_state=+new+trk,ipv6,reg0=0x200/0x200,reg4=0/0xc00000",
				ActStr:   "load:0x3->NXM_NX_REG4[22..23],ct(commit,table=SNATConntrackCommit,zone=65510,exec(load:0x1->NXM_NX_CT_MARK[4],load:0x1->NXM_NX_CT_MARK[5]))",
			},
			&ofTestUtils.ExpectFlow{
				MatchStr: "priority=200,ct_state=+new+trk,ipv6,reg0=0x1/0xf,reg4=0x400000/0xc00000",
				ActStr:   "load:0x3->NXM_NX_REG4[22..23],ct(commit,table=SNATConntrackCommit,zone=65510,exec(load:0x1->NXM_NX_CT_MARK[4]))",
			},
			&ofTestUtils.ExpectFlow{
				MatchStr: "priority=200,ct_state=+new+trk,ipv6,reg0=0x200/0x600,reg4=0xc00000/0xc00000",
			...
			&ofTestUtils.ExpectFlow{
				MatchStr: "priority=200,ct_state=+new+trk,ipv6,reg0=0x600/0x600,reg4=0xc00000/0xc00000",
			...
			&ofTestUtils.ExpectFlow{
				MatchStr: "priority=190,ct_state=+new+trk,ipv6,reg0=0x1/0xf,reg4=0xc00000/0xc00000",
				ActStr:   fmt.Sprintf("ct(commit,table=L2Forwarding,zone=65511,nat(src=%s),exec(load:0x1->NXM_NX_CT_MARK[2]))", config.nodeConfig.GatewayConfig.IPv6),
			},
			&ofTestUtils.ExpectFlow{
		...
		tableL3ForwardingFlows.flows = append(tableL3ForwardingFlows.flows,
			&ofTestUtils.ExpectFlow{MatchStr: fmt.Sprintf("priority=200,ipv6,reg0=0/0x800,ipv6_dst=%s", nodeIPStr), ActStr: "load:0x5->NXM_NX_REG0[4..7],goto_table:L2Forwarding"},
			&ofTestUtils.ExpectFlow{MatchStr: fmt.Sprintf("priority=200,ipv6,reg0=0x800/0x800,ipv6_dst=%s", nodeIPStr), ActStr: fmt.Sprintf("load:0x5->NXM_NX_REG0[4..7],set_field:%s->eth_dst,goto_table:ServiceHairpinMark", config.nodeConfig.GatewayConfig.MAC)},
		...
		tableServiceHairpinMarkFlows.flows = append(tableServiceHairpinMarkFlows.flows,
			...
			&ofTestUtils.ExpectFlow{MatchStr: "priority=190,ct_state=+new+trk,ipv6,reg0=0x51/0xff", ActStr: "load:0x1->NXM_NX_REG0[9],load:0->NXM_NX_REG4[22..23],load:0->NXM_NX_REG0[10],goto_table:IPTTLDec"},
			&ofTestUtils.ExpectFlow{MatchStr: "priority=190,ct_state=+new+trk,ipv6,reg0=0x61/0xff", ActStr: "load:0x1->NXM_NX_REG0[9],load:0->NXM_NX_REG4[22..23],load:0->NXM_NX_REG0[10],goto_table:IPTTLDec"},
		)
		tableIPTTLDecFlows.flows = append(tableIPTTLDecFlows.flows,
	...
	return []expectTableFlows{
		{
			...
			[]*ofTestUtils.ExpectFlow{
				{
					MatchStr: "priority=0",
					ActStr:   "load:0x6->NXM_NX_REG0[4..7],load:0x1->NXM_NX_REG4[24],goto_table:SNAT",
				},
			},
		},
		{
			...
			[]*ofTestUtils.ExpectFlow{
				{
					MatchStr: fmt.Sprintf("priority=190,ct_state=+new+trk,%s,reg0=0/0xf,reg4=0x1000000/0x1000000", ipProtoStr),
					ActStr:   "drop",
				},
				{
					MatchStr: fmt.Sprintf("priority=200,ct_state=-new+trk,%s,reg0=0/0xf,reg4=0x1000000/0x1000000", ipProtoStr),
	...
	return []expectTableFlows{
		{
			...
			[]*ofTestUtils.ExpectFlow{
				{
					MatchStr: fmt.Sprintf("priority=200,ct_state=+new+trk,%s,reg4=0x1000000/0x1000000,%s=%s", ipProtoStr, tunDstFieldName, snatIP),
					ActStr:   fmt.Sprintf("set_field:%s->eth_dst,load:0x%x->NXM_NX_PKT_MARK[0..7],goto_table:L2Forwarding", localGwMAC.String(), mark),
				},
				{
					MatchStr: fmt.Sprintf("priority=200,ct_state=+new+trk,%s,reg4=0x1000000/0x1000000,in_port=%d", ipProtoStr, podOFPort),
					ActStr:   fmt.Sprintf("load:0x%x->NXM_NX_PKT_MARK[0..7],goto_table:L2Forwarding", mark),
				},
				{
					MatchStr: fmt.Sprintf("priority=200,%s,reg4=0x1000000/0x1000000,in_port=%d", ipProtoStr, podOFPortRemote),
