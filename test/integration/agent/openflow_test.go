	...
	for _, ep := range endpointList {
		...
		if ep.GetIsLocal() {
			hairpinFlows.flows = append(hairpinFlows.flows, &ofTestUtils.ExpectFlow{
				...
				ActStr:   "load:0x1->NXM_NX_REG0[9],load:0x1->NXM_NX_REG0[10],load:0->NXM_NX_REG4[21..22],goto_table:L3DecTTL",
			})
		}
	}
				...
				[]*ofTestUtils.ExpectFlow{
					{
						...
						ActStr:   fmt.Sprintf("set_field:%s->eth_dst,load:0x1->NXM_NX_REG0[4..7],goto_table:L2ForwardingCalc", gwMAC.String()),
					},
					{
...
func prepareDefaultFlows(config *testConfig) []expectTableFlows {
	...
	tableConntrackCommitFlows := expectTableFlows{
		...
		flows:     []*ofTestUtils.ExpectFlow{{MatchStr: "priority=0", ActStr: "goto_table:L2ForwardingOut"}},
	}
	...
	tableL3ForwardingFlows := expectTableFlows{
		"L3Forwarding",
		[]*ofTestUtils.ExpectFlow{{MatchStr: "priority=0", ActStr: "goto_table:L2ForwardingCalc"}},
	}
	...
	tableServiceHairpinMarkFlows := expectTableFlows{
		...
		flows:     []*ofTestUtils.ExpectFlow{{MatchStr: "priority=0", ActStr: "goto_table:L3DecTTL"}},
	}
	if config.enableIPv4 {
		...
		tableSNATConntrackCommitFlows.flows = append(tableSNATConntrackCommitFlows.flows,
			...
			&ofTestUtils.ExpectFlow{
				...
				ActStr:   fmt.Sprintf("ct(commit,table=L2ForwardingCalc,zone=65521,nat(src=%s),exec(load:0x1->NXM_NX_CT_MARK[2]))", config1.VirtualServiceIPv4),
			},
			&ofTestUtils.ExpectFlow{
				MatchStr: "priority=200,ct_state=+new+trk,ip,reg0=0x600/0x600,reg4=0x600000/0x600000",
				ActStr:   fmt.Sprintf("ct(commit,table=L2ForwardingCalc,zone=65521,nat(src=%s),exec(load:0x1->NXM_NX_CT_MARK[2]))", config.nodeConfig.GatewayConfig.IPv4),
			},
			&ofTestUtils.ExpectFlow{
		...
		tableL3ForwardingFlows.flows = append(tableL3ForwardingFlows.flows,
			&ofTestUtils.ExpectFlow{MatchStr: fmt.Sprintf("priority=200,ip,reg0=0/0x800,nw_dst=%s", nodeIPStr), ActStr: "load:0x1->NXM_NX_REG0[4..7],goto_table:L2ForwardingCalc"},
			&ofTestUtils.ExpectFlow{MatchStr: fmt.Sprintf("priority=200,ip,reg0=0x800/0x800,nw_dst=%s", nodeIPStr), ActStr: fmt.Sprintf("set_field:%s->eth_dst,load:0x1->NXM_NX_REG0[4..7],goto_table:ServiceHairpinMark", config.nodeConfig.GatewayConfig.MAC)},
			&ofTestUtils.ExpectFlow{MatchStr: fmt.Sprintf("priority=190,ip,reg0=0/0x800,nw_dst=%s", podCIDR), ActStr: "load:0x2->NXM_NX_REG0[4..7],goto_table:L2ForwardingCalc"},
		)
		tableServiceHairpinMarkFlows.flows = append(tableServiceHairpinMarkFlows.flows,
			&ofTestUtils.ExpectFlow{MatchStr: "priority=210,ct_state=-new+trk,ct_mark=0x20/0x20,ip", ActStr: "load:0x1->NXM_NX_REG0[9],goto_table:L3DecTTL"},
			&ofTestUtils.ExpectFlow{MatchStr: "priority=200,ct_state=-new+trk,ip", ActStr: "goto_table:L3DecTTL"},
			&ofTestUtils.ExpectFlow{MatchStr: "priority=190,ct_state=+new+trk,ip,reg0=0x11/0xff", ActStr: "load:0x1->NXM_NX_REG0[9],load:0->NXM_NX_REG4[21..22],load:0->NXM_NX_REG0[10],goto_table:L3DecTTL"},
		)
	...
	if config.enableIPv6 {
		...
		tableSNATConntrackCommitFlows.flows = append(tableSNATConntrackCommitFlows.flows,
			...
			&ofTestUtils.ExpectFlow{
				...
				ActStr:   fmt.Sprintf("ct(commit,table=L2ForwardingCalc,zone=65511,nat(src=%s),exec(load:0x1->NXM_NX_CT_MARK[2]))", config1.VirtualServiceIPv6),
			},
			&ofTestUtils.ExpectFlow{
				MatchStr: "priority=200,ct_state=+new+trk,ipv6,reg0=0x600/0x600,reg4=0x600000/0x600000",
				ActStr:   fmt.Sprintf("ct(commit,table=L2ForwardingCalc,zone=65511,nat(src=%s),exec(load:0x1->NXM_NX_CT_MARK[2]))", config.nodeConfig.GatewayConfig.IPv6),
			},
			&ofTestUtils.ExpectFlow{
		...
		tableL3ForwardingFlows.flows = append(tableL3ForwardingFlows.flows,
			&ofTestUtils.ExpectFlow{MatchStr: fmt.Sprintf("priority=200,ipv6,reg0=0/0x800,ipv6_dst=%s", nodeIPStr), ActStr: "load:0x1->NXM_NX_REG0[4..7],goto_table:L2ForwardingCalc"},
			&ofTestUtils.ExpectFlow{MatchStr: fmt.Sprintf("priority=200,ipv6,reg0=0x800/0x800,ipv6_dst=%s", nodeIPStr), ActStr: fmt.Sprintf("set_field:%s->eth_dst,load:0x1->NXM_NX_REG0[4..7],goto_table:ServiceHairpinMark", config.nodeConfig.GatewayConfig.MAC)},
			&ofTestUtils.ExpectFlow{MatchStr: fmt.Sprintf("priority=190,ipv6,reg0=0/0x800,ipv6_dst=%s", podCIDR), ActStr: "load:0x2->NXM_NX_REG0[4..7],goto_table:L2ForwardingCalc"},
		)
		tableServiceHairpinMarkFlows.flows = append(tableServiceHairpinMarkFlows.flows,
			&ofTestUtils.ExpectFlow{MatchStr: "priority=210,ct_state=-new+trk,ct_mark=0x20/0x20,ipv6", ActStr: "load:0x1->NXM_NX_REG0[9],goto_table:L3DecTTL"},
			&ofTestUtils.ExpectFlow{MatchStr: "priority=200,ct_state=-new+trk,ipv6", ActStr: "goto_table:L3DecTTL"},
			&ofTestUtils.ExpectFlow{MatchStr: "priority=190,ct_state=+new+trk,ipv6,reg0=0x11/0xff", ActStr: "load:0x1->NXM_NX_REG0[9],load:0->NXM_NX_REG4[21..22],load:0->NXM_NX_REG0[10],goto_table:L3DecTTL"},
		)
		tableL3DecTTLFlows.flows = append(tableL3DecTTLFlows.flows,
	...
	return []expectTableFlows{
		{
			...
			[]*ofTestUtils.ExpectFlow{
				{
					MatchStr: "priority=0",
					ActStr:   "load:0x1->NXM_NX_REG4[23],load:0x1->NXM_NX_REG0[4..7],goto_table:SNAT",
				},
			},
		},
		{
			...
			[]*ofTestUtils.ExpectFlow{
				...
				},
				{
					...
					ActStr:   fmt.Sprintf("set_field:%s->eth_dst,goto_table:L2ForwardingCalc", gwMACStr),
				},
				{
					MatchStr: "priority=0",
			...
			[]*ofTestUtils.ExpectFlow{
				{
					...
					ActStr:   fmt.Sprintf("set_field:%s->eth_dst,load:0x%x->NXM_NX_PKT_MARK[0..7],goto_table:L2ForwardingCalc", localGwMAC.String(), mark),
				},
				{
					MatchStr: fmt.Sprintf("priority=200,ct_state=+new+trk,%s,reg4=0x800000/0x800000,in_port=%d", ipProtoStr, podOFPort),
					ActStr:   fmt.Sprintf("load:0x%x->NXM_NX_PKT_MARK[0..7],goto_table:L2ForwardingCalc", mark),
				},
				{
					MatchStr: fmt.Sprintf("priority=200,%s,reg4=0x800000/0x800000,in_port=%d", ipProtoStr, podOFPortRemote),
					ActStr:   fmt.Sprintf("set_field:%s->eth_src,set_field:%s->eth_dst,set_field:%s->%s,goto_table:L2ForwardingCalc", localGwMAC.String(), vMAC.String(), snatIP, tunDstFieldName),
				},
			},
		},
	}
